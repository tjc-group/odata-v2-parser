...
export namespace Lexer {
  ...
  export function pctEncodedNoSQUOTE(
    value: Utils.SourceArray,
    index: number
  ): number {
  ...
  export function pctEncodedUnescaped(
    value: Utils.SourceArray,
    index: number
  ): number {
    if (
  ...
  export function qcharNoAMPDQUOTE(
    value: Utils.SourceArray,
    index: number
  ): number {
  ...
  export function zeroToFiftyNine(
    value: Utils.SourceArray,
    index: number
  ): number {
    if (
  ...
  export function year(value: Utils.SourceArray, index: number): number {
    ...
    if (
      (value[index] === 0x30 &&
        (end = Utils.required(value, index + 1, Lexer.DIGIT, 3, 3))) ||
      (Lexer.oneToNine(value[index]) &&
        (end = Utils.required(value, index + 1, Lexer.DIGIT, 3)))
    )
      return end;
    return start;
  }
  ...
  export function geographyPrefix(
    value: Utils.SourceArray,
    index: number
  ): number {
    return Utils.equals(value, index, "geography") ? index + 9 : index;
  }
  export function geometryPrefix(
    value: Utils.SourceArray,
    index: number
  ): number {
  ...
  export function valueSeparator(
    value: Utils.SourceArray,
    index: number
  ): number {
    let bws = Lexer.BWS(value, index);
