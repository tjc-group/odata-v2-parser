...
class Parser {
    odataUri(source, options) {
        return exports.parserFactory(odataUri_1.default.odataUri)(source, options);
    }
    resourcePath(source, options) {
        return exports.parserFactory(resourcePath_1.default.resourcePath)(source, options);
    }
    query(source, options) {
        return exports.parserFactory(query_1.default.queryOptions)(source, options);
    }
    filter(source, options) {
        return exports.parserFactory(expressions_1.default.boolCommonExpr)(source, options);
    }
    keys(source, options) {
        return exports.parserFactory(expressions_1.default.keyPredicate)(source, options);
    }
    literal(source, options) {
        return exports.parserFactory(primitiveLiteral_1.default.primitiveLiteral)(source, options);
    }
}
