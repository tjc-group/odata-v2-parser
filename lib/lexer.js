...
(function (Lexer) {
    ...
    function tokenize(value, index, next, tokenValue, tokenType, metadataContextContainer) {
        let token = new exports.Token({
            ...
            value: tokenValue,
            type: tokenType,
            raw: tokenValue === "Edm.Binary" ? utils_1.default.toBinary(value, index, next) : utils_1.default.stringify(value, index, next)
        });
    ...
    function subDelims(value, index) {
        if (value[index] === 0x24 || value[index] === 0x26)
            ...
            return (Lexer.SQUOTE(value, index) ||
    ...
    function pctEncoded(value, index) {
        if (value[index] !== 0x25 ||
            !Lexer.HEXDIG(value[index + 1]) ||
            !Lexer.HEXDIG(value[index + 2]))
            return index;
        return index + 3;
    }
    ...
    function pchar(value, index) {
        if (Lexer.unreserved(value[index]))
            ...
            return (Lexer.subDelims(value, index) ||
    ...
    function pcharNoSQUOTE(value, index) {
        if (Lexer.unreserved(value[index]) ||
            ...
            return (Lexer.otherDelims(value, index) ||
                Lexer.EQ(value, index) ||
                Lexer.COLON(value, index) ||
                Lexer.AT(value, index) ||
    ...
    function qcharNoAMPDQUOTE(value, index) {
        ...
        if (Lexer.unreserved(value[index]) ||
            ...
            return (Lexer.otherDelims(value, index) ||
                Lexer.pctEncodedUnescaped(value, index));
    }
    ...
    function year(value, index) {
        ...
        if (value[index] === 0x2d)
            index++;
        if ((value[index] === 0x30 &&
            (end = utils_1.default.required(value, index + 1, Lexer.DIGIT, 3, 3))) ||
            (Lexer.oneToNine(value[index]) &&
                (end = utils_1.default.required(value, index + 1, Lexer.DIGIT, 3))))
            return end;
        return start;
    }
    Lexer.year = year;
